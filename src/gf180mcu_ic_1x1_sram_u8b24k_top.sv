...
module gf180mcu_ic_1x1_sram_u8b24k_top #(
    ...
    // Input pads (active low enable signals and address bits)
    generate
    ...
    // Bidirectional pads (data bus and remaining signals)
    generate
    ...
    // Analog pads (directly connected, unused for SRAM)
    generate
    ...
    // Core design
    gf180mcu_ic_1x1_sram_u8b24k_core #(
